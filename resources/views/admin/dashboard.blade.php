          ...
          <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
              <div class="navbar-nav mr-auto py-0">
                <a href="{{ Route('dashboard') }}" class="nav-item nav-link active">Admin Dashbord</a>
              </div>
              <div>
                                @if(Auth::check())


                                <button class="rounded-circle" style="width: 50px; height: 50px;margin-right: 25px; border-color: transparent; border: none;
  ...
  <div class="container-xxl py-5 mb-5">
    <div class="container">
      <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
        <h1 class="mb-5">Welcome to <span class="text-primary text-uppercase">Dashboard</span></h1>
      </div>
      ...
      <div class="row g-4">
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="border-color: black;">
          <a class="service-item rounded" href="{{Route('manage-users')}}">
        ...
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <a class="service-item rounded" href="">
            ...
            <h5 class="mb-3">Manage Property owner</h5>
          </a>
        </div>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <a class="service-item rounded" href="">
            ...
            <h5 class="mb-3">Listing approvals</h5>
          </a>
        </div>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <a class="service-item rounded" href="{{ url('/contact-list') }}">
            <div class="service-icon bg-transparent border rounded p-1">
              <div class="w-100 h-100 border rounded d-flex align-items-center justify-content-center">
                <i class="fa fa-envelope fa-2x text-primary"></i>
              </div>
            </div>
            <h5 class="mb-3">Massages</h5>
          </a>
        </div>
      </div>
    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer"><a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="btn btn-primary btn-block" >Logout</a></div>
