        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-1.jpg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Owner Register</h1>
                </div>
            </div>
        </div>
        <!-- Page Header End -->
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                                 <h3 class="mb-5">Owner<span class="text-primary text-uppercase">Register</span></h3>
                            </div>
                            ...
                            <form method="POST" action="{{ route('storeOwner') }}" enctype="multipart/form-data">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="file" class="form-control" id="image" name="image" placeholder="Your BR" value="{{ old('image') }}">
                                            <label for="image">Bussiness Registration</label>
                                            @error('image')
                                            <div class="alert alert-danger" role="alert">
                                                {{$message}}
                                            </div>
