    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <p class="col-md-12 col-form-label mx-5">gsgd dd ss sdsad vsdv sdvasdv asdv sdvsdv sdv asdv asdvsd vasdv asdv</p>
                <div class="card-body">
                    <form method="POST" action="{{ route('password.changepw') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="{{$email}}" value="{{$email}}">
                        ...
                        <div class="row mb-3">
                            <label for="password_confirmation" class="col-md-4 col-form-label text-md-end">{{ __('Comfirm Password') }}</label>
